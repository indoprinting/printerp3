            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="email" name="email" class="form-control form-control-border form-control-sm" placeholder="Ex. user@company.com">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="address" name="address" class="form-control form-control-border form-control-sm" placeholder="Ex. Jl. Bukit Kelapa xxx">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="city"><?= lang('App.city') ?></label>
                  <input id="city" name="city" class="form-control form-control-border form-control-sm" placeholder="Ex. Semarang">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="country" name="country" class="form-control form-control-border form-control-sm" placeholder="Ex. Indonesia">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="accname" name="accname" class="form-control form-control-border form-control-sm" placeholder="Ex. BCA, BNI, Mandiri">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="accno"><?= lang('App.accountnumber') ?></label>
                  <input id="accno" name="accno" class="form-control form-control-border form-control-sm" placeholder="Ex. 62502645xx">
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input id="accholder" name="accholder" class="form-control form-control-border form-control-sm" placeholder="Ex. Riyan Widiyanto">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label for="accbic"><?= lang('App.accountbic') ?></label>
                  <input id="accbic" name="accbic" class="form-control form-control-border form-control-sm" placeholder="Ex. CENAIJDA">
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <input type="number" class="form-control form-control-border form-control-sm" id="purchase_cycle" name="purchase_cycle">
              </div>
              <div class="col-md-6">
...
<script>
  ...
  $(document).ready(function() {
    initModalForm({
      form: '#form',
      submit: '#submit',
      url: base_url + '/humanresource/supplier/add'
    });
  });
</script>